...
class Zuchelli extends Scraper {
    constructor() {
        super(`https://zuchelihermanos.com/operaciones-propiedad/alquiler/`);
        this.selector = '.property-item.clearfix';
